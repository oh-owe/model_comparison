    ...
    def _process_service_info(self, info, name: str):
        ...
        try:
            ...
            if node_id in self.discovery_manager.discovered_nodes:
                ...
                try:
                    from .discovery_manager import DiscoveredNode
                except ImportError:
                    from discovery_manager import DiscoveredNode
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='mDNS Service Broadcaster for InferNode Discovery',
...
Examples:
  ...
  python mdns_manager.py --node-id test --node-name "Test" \\
    ...
    mdns_broadcaster = MDNSBroadcaster(args.node_id, node_info, args.port)
